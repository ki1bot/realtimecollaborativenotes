              ...
              <div className="relative grid gap-8 lg:grid-cols-[minmax(0,1fr)_340px] lg:items-end">
                <div>
                  ...
                  <p className="mt-5 max-w-2xl text-base leading-8 text-slate-600 dark:text-slate-400">
                    Buat, edit, dan bagikan catatan tanpa membuat alur kerja
                    jadi ribet. Fokus utama aplikasi ini adalah CRUD stabil,
                    kolaborasi realtime, dan akses role yang jelas.
                  </p>
                  ...
                  <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                    ...
                    <div className="relative w-full sm:max-w-sm">
                      ...
                      <input
                        ...
                        className="h-full w-full rounded-2xl border border-slate-200 bg-white/90 py-3 pl-11 pr-4 text-sm font-semibold text-slate-900 outline-none transition focus:border-blue-500 focus:ring-4 focus:ring-blue-500/15 dark:border-slate-800 dark:bg-slate-950/70 dark:text-slate-100"
                      />
                    </div>
                  </div>
                </div>
